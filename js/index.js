if (!checkCookie('ig-fg')) setCookie('ig-fg', [56, 56, 56], 365);
if (!checkCookie('ig-bg')) setCookie('ig-bg', [23, 23, 23], 365);
if (!checkCookie('ig-text')) setCookie('ig-text', [255, 255, 255], 365);
...
function resetColours() {
    setCookie('ig-fg', [56, 56, 56], 365);
    setCookie('ig-bg', [23, 23, 23], 365);
    setCookie('ig-text', [255, 255, 255], 365);
    changeColour('fg');
    changeColour('bg');
    changeColour('text');
}